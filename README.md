...
* **MOBILE SUPPORT** - This is cool - try loading the [**the demo page**](http://neverson42.github.io/skipepe.js) on a mobile device and then use your finger to direct the skier around the piste. Also try double-tap ;)
